...
class ConnectionStub:
  ...
  def addServer(self, si:ServerInfo):
    self._connections[si.name]=si
    self._blocking_clients[si.name] = TcpClient(si, sock_pool_sz=self._sock_pool_sz)
    self._non_blocking_clients[si.name] = TcpClient(si, blocking=False ,sock_pool_sz=self._sock_pool_sz)
